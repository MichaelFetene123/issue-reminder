...
export default async function IssueDetailPage({
  ...
  return (
    <div className="max-w-4xl mx-auto p-4 md:p-8 animate-in fade-in duration-500 slide-in-from-bottom-4">
      ...
      <div className="bg-card text-card-foreground border rounded-xl shadow-sm p-6 mb-8 transition-all hover:shadow-md">
      ...
      <div className="bg-card text-card-foreground border rounded-xl shadow-sm p-6 transition-all hover:shadow-md">
        <h2 className="text-lg font-semibold mb-5 flex items-center tracking-tight">Details</h2>
